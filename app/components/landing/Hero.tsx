...
import { ArrowRight, Bot, CheckCircle2, Code2, FileText, Github, Link2, StickyNote, Terminal, Zap } from 'lucide-react'
  ...
  return (
    <section className="relative overflow-hidden border-b border-zinc-200 bg-stone-50 dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-20 sm:px-6 lg:px-8 lg:pt-28">
        {/* Open source + founding member badges */}
        <div className="mb-6 flex flex-wrap items-center justify-center gap-2.5">
          <a
            href="https://github.com/Rayan9064/dumpit"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-full border border-zinc-200 bg-white px-3.5 py-1.5 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800"
          >
        ...
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-5xl font-extrabold leading-[1.08] tracking-tight text-zinc-950 dark:text-white sm:text-6xl lg:text-7xl">
            Your saved content,
            <br />
        ...
        <div className="mx-auto mt-10 max-w-xl">
          <div className="overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900 shadow-xl shadow-black/20">
            ...
            <div className="flex items-center gap-2 border-b border-zinc-800 bg-zinc-950 px-4 py-2.5">
              ...
              <Terminal className="ml-2 h-3.5 w-3.5 text-zinc-500" />
              <span className="text-xs font-medium text-zinc-400">Claude Desktop · DumpIt MCP</span>
            </div>
            {/* Conversation snippet */}
            <div className="space-y-3 p-4 text-sm">
              <div className="flex items-start gap-2.5">
                <span className="mt-0.5 shrink-0 rounded bg-zinc-700 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-zinc-300">You</span>
                <span className="text-zinc-200">What did I save about RAG citation patterns?</span>
              </div>
              <div className="flex items-start gap-2.5">
                ...
                <div className="text-zinc-300">
                  <span className="text-zinc-500 text-xs">[via DumpIt MCP]</span> Found 3 resources in your vault —
                  <br />
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          {user ? (
            ...
            <>
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center gap-2 rounded-xl border border-zinc-200 bg-white px-6 py-3.5 text-sm font-semibold text-zinc-700 shadow-sm transition hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800"
              >
                See how it works
              </a>
            </>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-3">
          {trustItems.map(({ label }) => (
            <div key={label} className="flex items-center gap-1.5 text-sm text-zinc-500 dark:text-zinc-400">
        ...
        <div className="relative mx-auto mt-20 max-w-4xl">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl shadow-zinc-300/40 dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-black/40">
            {/* Browser chrome */}
            <div className="flex items-center gap-2 border-b border-zinc-200 bg-zinc-50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <div className="mx-auto flex items-center gap-2 rounded-md border border-zinc-200 bg-white px-3 py-1 text-xs text-zinc-400 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <div className="border-b border-zinc-200 p-5 dark:border-zinc-800 lg:border-b-0 lg:border-r">
                <div className="mb-3 flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-zinc-900 dark:text-white">Ask DumpIt</span>
                ...
                <div className="mb-4 rounded-lg border border-zinc-200 bg-zinc-50 p-3 text-sm text-zinc-700 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-200">
              ...
              {/* Right — Saved items */}
              <div className="bg-zinc-50 p-5 dark:bg-zinc-950/60">
                <div className="mb-3 text-xs font-bold uppercase tracking-wide text-zinc-400 dark:text-zinc-500">Recent saves</div>
                <div className="space-y-2.5">
                  {[
                    ...
                    return (
                      <div key={item.label} className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-white p-3 dark:border-zinc-800 dark:bg-zinc-900">
                        <ItemIcon className={`h-4 w-4 shrink-0 ${item.color}`} />
                        <div className="min-w-0 flex-1">
                          <div className="truncate text-sm font-medium text-zinc-900 dark:text-white">{item.label}</div>
                        </div>
                        <span className="shrink-0 rounded-full bg-zinc-100 px-2 py-0.5 text-[11px] font-semibold text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">{item.type}</span>
                      </div>
                    )
                  })}
                </div>
