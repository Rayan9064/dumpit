    ...
    <section className="relative overflow-hidden bg-zinc-950 py-28 text-white">
      ...
      <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <div className="mb-5 flex justify-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-semibold text-zinc-300">
        ...
        {user ? (
          <button
            ...
            className="mt-10 inline-flex items-center gap-2 rounded-xl bg-white px-8 py-4 text-base font-bold text-zinc-950 shadow-xl transition hover:bg-zinc-100"
          >
            Open your vault
