...
const surfaces = [
    ...
    preview: (
      <div className="space-y-2 rounded-lg border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-700 dark:bg-zinc-900">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-zinc-600 dark:text-zinc-300">app.dumpit.app/dashboard</span>
        </div>
        <div className="space-y-1.5">
          {['RAG citation patterns', 'Firebase auth guide', 'Next.js deployment.pdf'].map((item) => (
            <div key={item} className="flex items-center justify-between rounded border border-zinc-200 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-800">
              <span className="text-xs text-zinc-700 dark:text-zinc-200">{item}</span>
    ...
    preview: (
      <div className="space-y-2 rounded-lg border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-700 dark:bg-zinc-900">
        <div className="flex items-center justify-between">
          <span className="text-xs font-bold text-zinc-700 dark:text-white">DumpIt</span>
        ...
        <div className="rounded border border-zinc-200 bg-white p-2 text-xs text-zinc-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
  ...
  },
  {
    ...
    preview: (
      <div className="rounded-lg border border-zinc-200 bg-zinc-900 p-3 font-mono text-xs dark:border-zinc-700">
  ...
  },
  {
    ...
    preview: (
      <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-700 dark:bg-zinc-900">
        <div className="mb-2 text-xs font-bold text-zinc-600 dark:text-zinc-300">Claude + DumpIt MCP</div>
        <div className="rounded border border-zinc-200 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <div className="text-xs text-zinc-700 dark:text-zinc-200">What did I save about Gemini pricing?</div>
        </div>
        <div className="mt-1.5 rounded border border-blue-100 bg-blue-50 p-2 dark:border-blue-900 dark:bg-blue-950/30">
          ...
          <div className="text-xs text-zinc-700 dark:text-zinc-200">From your vault: Gemini Flash is $0.15/M input... [Source: dumpit_plan.md]</div>
        </div>
      </div>
    ),
  },
...
const Platform = () => {
  return (
    <section id="platform" className="scroll-mt-20 border-b border-zinc-200 bg-stone-50 py-24 dark:border-zinc-800 dark:bg-[#0b0f17]">
            ...
            return (
              <article key={surface.title} className="app-panel flex flex-col p-5">
                <div className="mb-4 flex items-start justify-between gap-3">
                  ...
                  <span className="rounded-full border border-zinc-200 bg-zinc-100 px-2 py-0.5 text-[11px] font-semibold text-zinc-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400">
                    {surface.tag}
                  </span>
                </div>
                <h3 className="mb-1 font-bold text-zinc-950 dark:text-white">{surface.title}</h3>
                <p className="mb-4 text-sm leading-6 text-zinc-600 dark:text-zinc-300">{surface.description}</p>
                {surface.preview}
              </article>
            )
          })}
